function [accuracy_lbi_alpha,accuracy_lbi_tilde_alpha] = split_lbi_zst_validation(list_train,list_validate,file_image,Attribute,save_lbi_num,alpha,tilde_alpha)
load(file_image);
...
for t = 1:save_lbi_num
    ...
    [accuracy_A_Rec_LBI,~] = classifier_nearest(X,FeaRecon_A,list_validate,Y);
